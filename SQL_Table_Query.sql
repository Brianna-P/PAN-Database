...
-- Team table
CREATE TABLE Team (
    TeamName VARCHAR(100) PRIMARY KEY NONCLUSTERED,
    TeamType VARCHAR(50),
    DateFormed DATE,
);
...
CREATE TABLE ReportsTo (
    ...
    --Nullable date and description for query 5. Can update if a report is made.
    PRIMARY KEY NONCLUSTERED(SSN, TeamName),
    FOREIGN KEY (SSN) REFERENCES Employee(SSN),
